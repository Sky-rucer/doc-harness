...
- `skill/SKILL.md` — Entry point and router (~45 lines)
- `skill/init.md` — `/doc-harness init` instructions and templates
- `skill/check.md` — `/doc-harness check` audit + reflection procedures
- `skill/operational_rules.md` — Rules embedded in each project's CLAUDE.md (~110 lines)
- `skill/spec.md` — Complete Doc Harness specification (~830 lines, 12 chapters + 4 appendices)
